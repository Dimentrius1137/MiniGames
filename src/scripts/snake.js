export default class InitGame {
    ...
    CreateFood(){
        ...
        ctx.fillStyle = "black";
        ctx.fillRect(apple.x, apple.y, this.step, this.step);
    ...
    InitSnake(){
        const ctx = this.ref.getContext("2d");
            ...
            for(let i = 0; i < this.snake.length; i++){
                ...
                ctx.fillStyle = "#ABBA72";
                ctx.fillRect(this.snake[i].x + 2, this.snake[i].y + 2, this.step-4, this.step-4);
                ctx.fillStyle = "#708240";
                ctx.fillRect(this.snake[0].x + 2, this.snake[0].y + 2, this.step-4, this.step-4);
            }
